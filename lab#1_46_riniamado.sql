...
USE company;
CREATE TABLE regions(region_id int not null,region_name varchar(40) not null,primary key(region_id));
CREATE  table countries(country_id varchar(5) not null,country_name varchar(30),region_id int,primary key(country_id),foreign key(region_id) references regions(region_id));
